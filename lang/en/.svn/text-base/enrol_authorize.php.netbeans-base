...
$string['apilogin'] = 'API Login ID';
$string['apilogin_desc'] = 'Identifier for Authorize.Net account';
...
$string['callsupport'] = 'If this is the first time you have received this error, please verify that all of your payment information was entered correctly. If this is not the first time you have received this message, please email academy@mises.org or call 1-800-636-4737 for assistance.';
...
$string['firstnameoncard'] = 'First name on card';
...
$string['lastnameoncard'] = 'Last name on card';
...
$string['transactionkey_desc'] = 'Secret key for Authorize.Net transactions';
...
Thanks for your payments. You have been enrolled in these courses:
...
$string['receipt_settings'] = 'Receipt settings';
$string['reecipt_settings_desc'] = 'Settings used when printing receipts';
$string['receipt_prefix'] = 'Receipt number prefix';
$string['receipt_prefix_desc'] = 'This text will be prepended to the receipt number';
$string['receipt_nextnumber'] = 'Next receipt number';
$string['receipt_nextnumber_desc'] = '';
$string['receipt_addresshtml'] = 'HTML for company name and address on receipt';
